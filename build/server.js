...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _jsonwebtoken = __webpack_require__(106);
  ...
  var _prettyError = __webpack_require__(112);
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _nodeFetch = __webpack_require__(108);
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _ImageFigure = __webpack_require__(32);
  
  var _ImageFigure2 = _interopRequireDefault(_ImageFigure);
  
  var _ControllerUnit = __webpack_require__(30);
  ...
  var App = function (_Component) {
    ...
    (0, _createClass3.default)(App, [{
      ...
      value: function componentDidMount() {
        ...
        var imageFigureDom = _reactDom2.default.findDOMNode(this.refs.imageFigure0);
      ...
      value: function render() {
        ...
        return !this.props.error ? _react2.default.createElement(
          ...
          _react2.default.createElement(
            'section',
            { className: _App2.default.stage, ref: 'stage' },
            _react2.default.createElement(
              'section',
              { className: _App2.default.imageContent },
              imageFigures
            ),
            _react2.default.createElement(
              'nav',
              { className: _App2.default.controllerContent },
              controllerUnits
            )
          )
        ) : this.props.children;
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _ControllerUnit = __webpack_require__(70);
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _ImageFigure = __webpack_require__(72);
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _pg = __webpack_require__(111);
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _passport = __webpack_require__(109);
  
  var _passport2 = _interopRequireDefault(_passport);
  
  var _passportFacebook = __webpack_require__(110);
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var _markdownIt = __webpack_require__(107);
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  // exports
  exports.locals = {
  	"content": "App_content_3Qb",
  	"stage": "App_stage_2Lu",
  	"imageContent": "App_imageContent_1KH",
  	"controllerContent": "App_controllerContent_3W0"
  };
...
/***/ (function(module, exports, __webpack_require__) {
      ...
      // Only activated in browser context
      if (false) {
        module.hot.accept("!!../../../node_modules/css-loader/index.js?sourceMap&modules&localIdentName=[name]_[local]_[hash:base64:3]!../../../node_modules/postcss-loader/index.js?parser=postcss-scss!./ImageFigure.scss", function() {
          var newContent = require("!!../../../node_modules/css-loader/index.js?sourceMap&modules&localIdentName=[name]_[local]_[hash:base64:3]!../../../node_modules/postcss-loader/index.js?parser=postcss-scss!./ImageFigure.scss");
          if (typeof newContent === 'string') {
            newContent = [[module.id, content, '']];
          }
          removeCss = insertCss(newContent, { replace: true });
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  var jade_debug = [ new jade.DebugItem( 1, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ) ];
  try {
  var buf = [];
  var jade_mixins = {};
  var jade_interp;
  ;var locals_for_with = (locals || {});(function (stack) {
  jade_debug.unshift(new jade.DebugItem( 0, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  jade_debug.unshift(new jade.DebugItem( 1, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<!DOCTYPE html>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 2, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<html lang=\"en\">");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 3, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<head>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 4, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<meta charset=\"utf-8\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 5, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<title>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  ...
  buf.push("</title>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 6, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 7, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<style>");
  ...
  buf.push("</head>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 59, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<body>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 60, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<h1>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  ...
  buf.push("</h1>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 61, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  buf.push("<p>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  ...
  buf.push("</p>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 62, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
  ...
  buf.push("</html>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 63, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\error.jade" ));
...
/***/ (function(module, exports, __webpack_require__) {
  ...
  module.exports = function template(locals) {
  var jade_debug = [ new jade.DebugItem( 1, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ) ];
  try {
  var buf = [];
  var jade_mixins = {};
  var jade_interp;
  ;var locals_for_with = (locals || {});(function (body, css, description, entry, title, trackingId) {
  jade_debug.unshift(new jade.DebugItem( 0, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  jade_debug.unshift(new jade.DebugItem( 1, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<!DOCTYPE html>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 2, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<html lang=\"\" class=\"no-js\">");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 3, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<head>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 4, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<meta charset=\"utf-8\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 5, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<meta http-equiv=\"x-ua-compatible\" content=\"ie=edge\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 6, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<title>" + (jade.escape(null == (jade_interp = title) ? "" : jade_interp)));
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.shift();
  buf.push("</title>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 7, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<meta name=\"description\"" + (jade.attr("description", description, true, true)) + ">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 8, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 9, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<link rel=\"apple-touch-icon\" href=\"apple-touch-icon.png\">");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 10, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  ...
  buf.push("</head>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 11, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<body>");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.unshift(new jade.DebugItem( 12, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<div id=\"app\">" + (null == (jade_interp = body) ? "" : jade_interp));
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.shift();
  buf.push("</div>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 13, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<script" + (jade.attr("src", entry, true, true)) + ">");
  jade_debug.unshift(new jade.DebugItem( undefined, jade_debug[0].filename ));
  jade_debug.shift();
  buf.push("</script>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 14, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  buf.push("<script>");
  ...
  buf.push("</script>");
  jade_debug.shift();
  jade_debug.unshift(new jade.DebugItem( 17, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  if ( trackingId)
  {
  jade_debug.unshift(new jade.DebugItem( 18, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
  jade_debug.unshift(new jade.DebugItem( 18, "E:\\sites\\test.jay\\fatManAlbum\\src\\views\\index.jade" ));
